...
extern LPSTR get_access_method(PCERT_AUTHORITY_INFO_ACCESS info_access, int index);
extern LPWSTR get_access_location(PCERT_AUTHORITY_INFO_ACCESS info_access, int index);
